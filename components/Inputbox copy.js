...
import { Firebase, addDoc, collection, Firestore, getFirestore, serverTimestamp } from "firebase/firestore";
import { ref, uploadString, getDownloadURL, getStorage  } from "firebase/storage";

//deprecated imports from v8
...
function Inputbox () {
    ...
    const {imageToPost, setImageToPost} = useRef(null);
        ...
        <div className="bg-white p-2 rounded-2xl shadow-md text-gray-500 font-medium mt-6">
            ...
            {imageToPost && (
                <div onClick={removeImage} className="flex flex-col filter hover:brightness-110 transition duration-150 transform hover:scale-105 cursor-pointer">
                    <img className="h-10 object-contain rounded-full" 
                    src={imageToPost} 
                    alt="uploaded image" 
                    />
